...
/**
 * This class provides implementation to ITestListener for TestNG
 * 
 * @author Arundhati
 */
public class ListenersImplementation implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String path = selutil.captureScreenshot(BaseClass.sdriver, screenshotName);
	...
	public void onStart(ITestContext context) {
		...
		report.setSystemInfo("Base Browser", "Arundhati");
